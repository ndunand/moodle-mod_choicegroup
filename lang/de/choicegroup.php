...
$string['expired'] = 'Diese Abstimmung ist seit {$a} beendet. Eine Stimmabgabe ist nicht mehr m&ouml;glich.';
$string['fillinatleastoneoption'] = 'Mindestens zwei Antworten sind von N&ouml;ten.';
$string['full'] = '(Obergrenze erreicht)';
$string['havetologin'] = 'Sie m&uuml;ssen sich erst anmelden, bevor Sie sich an der Abstimmung beteiligen k&ouml;nnen.';
$string['choice'] = 'Abstimmung {$a}';
$string['choicegroupclose'] = 'bis';
$string['choicegroup:deleteresponses'] = 'Stimmabgaben l&ouml;schen';
$string['choicegroup:downloadresponses'] = 'Stimmabgaben herunterladen';
$string['choicegroupfull'] = 'Diese Abstimmoption ist voll und es gibt keine verf&uuml;gbaren Pl&auml;tze mehr.';
$string['choicegroup:choose'] = 'Abstimmung vornehmen';
$string['choicegroupname'] = 'Gruppenabstimmungsname';
$string['choicegroupopen'] = 'von';
$string['choicegroupoptions'] = 'Abstimmungsoptionen';
$string['choicegroupoptions_help'] = 'Tragen Sie hier die einzelnen Optionen ein, zwischen denen sich die Teilnehmer/innen entscheiden k&ouml;nnen.

Sie k&ouml;nnen jedes der vorhandenen Felder ausf&uuml;llen, Sie d&uuml;rfen aber auch nicht ben&ouml;tigte Felder leer lassen, die dann in der Abstimmung nicht angezeigt werden. Ben&ouml;tigen Sie weitere Optionen, so klicken Sie auf den Knopf "Weitere Optionen hinzuf&uuml;gen".';
...
$string['chooseaction'] = 'Aktion ausw&auml;hlen...';
$string['choosegroup'] = 'W&auml;hlen Sie eine Gruppe';
$string['limit'] = 'Obergrenze';
$string['limitanswers'] = 'Obergrenzen f&uuml;r Abstimmung';
$string['modulename'] = 'Gruppenabstimmung';
$string['modulename_help'] = 'Das Modul \'Gruppenabstimmung\' erm&ouml;glicht es, per Abstimmung Nutzer/innen in Gruppen einzuordnen.';
...
$string['publishnames'] = 'Anonyme Ergebnisse';
...
$string['yourselection'] = 'Mit Auswahl';

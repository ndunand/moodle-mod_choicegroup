...
$string['allowupdate'] = 'Laisser le choix &ecirc;tre mis &agrave; jour';
...
$string['expired'] = 'D&eacute;sol&eacute;, cette activit&eacute; est ferm&eacute;e depuis le {$a} et n\'est plus disponible';
$string['fillinatleastoneoption'] = 'Vous devez fournir au moins deux r&eacute;ponses possibles.';
$string['full'] = '(Complet)';
...
$string['pluginname'] = 'Choix';
$string['privacy'] = 'Confidentialit&eacute; des r&eacute;sultats';
$string['publish'] = 'Publier les r&eacute;sultats';
$string['publishafteranswer'] = 'Afficher les r&eacute;sultats pour les &eacute;tudiants apr&egrave;s leur r&eacute;ponse';
$string['publishafterclose'] = 'Afficher les r&eacute;sultats pour les &eacute;tudiants seulement apr&egrave;s que le choix est ferm&eacute;';
$string['publishalways'] = 'Toujours afficher les r&eacute;sultats aux &eacute;l&egrave;ves';
$string['publishanonymous'] = 'Publier les r&eacute;sultats anonymes, ne montrent pas les noms des &eacute;l&egrave;ves';
$string['publishnames'] = 'Publier les r&eacute;sultats complets, indiquant les noms et leurs choix';
$string['publishnot'] = 'Ne pas publier les r&eacute;sultats d\'&eacute;l&egrave;ves';
...
$string['taken'] = 'Pris';
$string['timerestrict'] = 'Restreindre la r&eacute;ponse &agrave; cette p&eacute;riode de temp';
$string['viewallresponses'] = 'Afficher {$a} r&eacute;ponses';
$string['withselected'] = 'Avec xxx';
$string['yourselection'] = 'Votre s&eacute;lection';
